...
GPIO_TypeDef* vectpxM2SGpioPort[2][M2S_GPIO_NUMBER] = {
  {M2S_GPIO_0_PORT_V_23,M2S_GPIO_1_PORT_V_23,M2S_GPIO_2_PORT_V_23,M2S_GPIO_3_PORT_V_23,M2S_GPIO_SDN_PORT},
  {M2S_GPIO_0_PORT_V_D1,M2S_GPIO_1_PORT_V_D1,M2S_GPIO_2_PORT_V_D1,M2S_GPIO_3_PORT_V_D1,M2S_GPIO_SDN_PORT},
...
static const uint32_t s_vectlM2SGpioClk[2][M2S_GPIO_NUMBER] = {
  {M2S_GPIO_0_RCC_PORT_V_23,M2S_GPIO_1_RCC_PORT_V_23,M2S_GPIO_2_RCC_PORT_V_23,M2S_GPIO_3_RCC_PORT_V_23,M2S_GPIO_SDN_RCC_PORT},
  {M2S_GPIO_0_RCC_PORT_V_D1,M2S_GPIO_1_RCC_PORT_V_D1,M2S_GPIO_2_RCC_PORT_V_D1,M2S_GPIO_3_RCC_PORT_V_D1,M2S_GPIO_SDN_RCC_PORT},
};
...
static const uint8_t s_vectcM2SGpioExtiPortSource[2][M2S_GPIO_NUMBER-1] = {
  {M2S_GPIO_0_EXTI_PORT_SOURCE_V_23,M2S_GPIO_1_EXTI_PORT_SOURCE_V_23,M2S_GPIO_2_EXTI_PORT_SOURCE_V_23,M2S_GPIO_3_EXTI_PORT_SOURCE_V_23},
  {M2S_GPIO_0_EXTI_PORT_SOURCE_V_D1,M2S_GPIO_1_EXTI_PORT_SOURCE_V_D1,M2S_GPIO_2_EXTI_PORT_SOURCE_V_D1,M2S_GPIO_3_EXTI_PORT_SOURCE_V_D1},
...
{
  if(xNewState)
    EXTI->RTSR |= (uint16_t)s_vectlM2SExtiLine[xGpio];
  else
    EXTI->RTSR &= ~(uint16_t)s_vectlM2SExtiLine[xGpio];
}
...
{
  if(xNewState)
    EXTI->FTSR |= (uint16_t)s_vectlM2SExtiLine[xGpio];
  else
    EXTI->FTSR &= ~(uint16_t)s_vectlM2SExtiLine[xGpio];
}
