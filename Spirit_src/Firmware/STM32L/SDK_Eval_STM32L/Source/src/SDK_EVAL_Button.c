...
GPIO_TypeDef* s_vectpxButtonPortVersion[3][BUTTONn] = {
    {KEY_BUTTON_GPIO_PORT, RIGHT_BUTTON_GPIO_PORT, LEFT_BUTTON_V2_GPIO_PORT, UP_BUTTON_V2_GPIO_PORT, DOWN_BUTTON_GPIO_PORT, SEL_BUTTON_V2_GPIO_PORT, SCM_PS_BUTTON_GPIO_PORT},
    {KEY_BUTTON_GPIO_PORT, RIGHT_BUTTON_GPIO_PORT, LEFT_BUTTON_V3_GPIO_PORT, UP_BUTTON_V3_GPIO_PORT, DOWN_BUTTON_GPIO_PORT, SEL_BUTTON_V3_GPIO_PORT, SCM_PS_BUTTON_GPIO_PORT},
...
static const uint16_t s_vectnButtonPinVersion[3][BUTTONn] = {
    {KEY_BUTTON_PIN, RIGHT_BUTTON_PIN, LEFT_BUTTON_V2_PIN, UP_BUTTON_V2_PIN, DOWN_BUTTON_PIN, SEL_BUTTON_V2_PIN, SCM_PS_BUTTON_PIN},
    {KEY_BUTTON_PIN, RIGHT_BUTTON_PIN, LEFT_BUTTON_V3_PIN, UP_BUTTON_V3_PIN, DOWN_BUTTON_PIN, SEL_BUTTON_V3_PIN, SCM_PS_BUTTON_PIN},
...
static const uint32_t s_vectlButtonClkVersion[3][BUTTONn] = {
    {KEY_BUTTON_GPIO_CLK, RIGHT_BUTTON_GPIO_CLK, LEFT_BUTTON_V2_GPIO_CLK, UP_BUTTON_V2_GPIO_CLK, DOWN_BUTTON_GPIO_CLK, SEL_BUTTON_V2_GPIO_CLK, SCM_PS_BUTTON_GPIO_CLK},
    {KEY_BUTTON_GPIO_CLK, RIGHT_BUTTON_GPIO_CLK, LEFT_BUTTON_V3_GPIO_CLK, UP_BUTTON_V3_GPIO_CLK, DOWN_BUTTON_GPIO_CLK, SEL_BUTTON_V3_GPIO_CLK, SCM_PS_BUTTON_GPIO_CLK},
...
static const uint16_t s_vectnButtonExtiLineVersion[3][BUTTONn] = {
    {KEY_BUTTON_EXTI_LINE, RIGHT_BUTTON_EXTI_LINE, LEFT_BUTTON_V2_EXTI_LINE, UP_BUTTON_V2_EXTI_LINE, DOWN_BUTTON_EXTI_LINE, SEL_BUTTON_V2_EXTI_LINE, SCM_PS_BUTTON_EXTI_LINE},
    {KEY_BUTTON_EXTI_LINE, RIGHT_BUTTON_EXTI_LINE, LEFT_BUTTON_V3_EXTI_LINE, UP_BUTTON_V3_EXTI_LINE, DOWN_BUTTON_EXTI_LINE, SEL_BUTTON_V3_EXTI_LINE, SCM_PS_BUTTON_EXTI_LINE},
...
static const uint16_t s_vectnButtonPortSourceVersion[3][BUTTONn] = {
    {KEY_BUTTON_EXTI_PORT_SOURCE, RIGHT_BUTTON_EXTI_PORT_SOURCE, LEFT_BUTTON_V2_EXTI_PORT_SOURCE, UP_BUTTON_V2_EXTI_PORT_SOURCE, DOWN_BUTTON_EXTI_PORT_SOURCE, SEL_BUTTON_V2_EXTI_PORT_SOURCE, SCM_PS_BUTTON_EXTI_PORT_SOURCE},
    {KEY_BUTTON_EXTI_PORT_SOURCE, RIGHT_BUTTON_EXTI_PORT_SOURCE, LEFT_BUTTON_V3_EXTI_PORT_SOURCE, UP_BUTTON_V3_EXTI_PORT_SOURCE, DOWN_BUTTON_EXTI_PORT_SOURCE, SEL_BUTTON_V3_EXTI_PORT_SOURCE, SCM_PS_BUTTON_EXTI_PORT_SOURCE},
...
static const uint16_t s_vectnButtonPinSourceVersion[3][BUTTONn] = {
    {KEY_BUTTON_EXTI_PIN_SOURCE, RIGHT_BUTTON_EXTI_PIN_SOURCE, LEFT_BUTTON_V2_EXTI_PIN_SOURCE, UP_BUTTON_V2_EXTI_PIN_SOURCE, DOWN_BUTTON_EXTI_PIN_SOURCE, SEL_BUTTON_V2_EXTI_PIN_SOURCE, SCM_PS_BUTTON_EXTI_PIN_SOURCE},
    {KEY_BUTTON_EXTI_PIN_SOURCE, RIGHT_BUTTON_EXTI_PIN_SOURCE, LEFT_BUTTON_V3_EXTI_PIN_SOURCE, UP_BUTTON_V3_EXTI_PIN_SOURCE, DOWN_BUTTON_EXTI_PIN_SOURCE, SEL_BUTTON_V3_EXTI_PIN_SOURCE, SCM_PS_BUTTON_EXTI_PIN_SOURCE},
...
static const uint16_t s_vectnButtonIrqnVersion[3][BUTTONn] = {
    {KEY_BUTTON_EXTI_IRQn, RIGHT_BUTTON_EXTI_IRQn, LEFT_BUTTON_V2_EXTI_IRQn, UP_BUTTON_V2_EXTI_IRQn, DOWN_BUTTON_EXTI_IRQn, SEL_BUTTON_V2_EXTI_IRQn, SCM_PS_BUTTON_EXTI_IRQn},
    {KEY_BUTTON_EXTI_IRQn, RIGHT_BUTTON_EXTI_IRQn, LEFT_BUTTON_V3_EXTI_IRQn, UP_BUTTON_V3_EXTI_IRQn, DOWN_BUTTON_EXTI_IRQn, SEL_BUTTON_V3_EXTI_IRQn, SCM_PS_BUTTON_EXTI_IRQn},
...
static uint16_t* s_vectnButtonIrqn;
...
{
  if(GPIO_ReadInputDataBit(s_vectpxButtonPort[xButton], s_vectnButtonPin[xButton]))
    return SET;
  else
    return RESET;
}
