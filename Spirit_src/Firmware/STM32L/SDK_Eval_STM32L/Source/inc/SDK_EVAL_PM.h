 ...
 * @version 3.2.1
 * @date    May 1, 2015
 * @brief   This file contains definitions for Software Development Kit eval board Digipots.
 * @details
 *
 * This module can be used to regulate the supply voltage.
 ...
 * @brief Management of Software Development Kit eval board Digipots.
...
#define DIGIPOT_I2C_SPEED   100000
