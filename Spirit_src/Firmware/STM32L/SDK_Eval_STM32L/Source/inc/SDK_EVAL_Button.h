 ...
 */
#define LEFT_BUTTON_V2_PIN                  GPIO_Pin_6
#define LEFT_BUTTON_V2_GPIO_PORT            GPIOE
#define LEFT_BUTTON_V2_GPIO_CLK             RCC_AHBPeriph_GPIOE
#define LEFT_BUTTON_V2_EXTI_LINE            EXTI_Line6
#define LEFT_BUTTON_V2_EXTI_PORT_SOURCE     EXTI_PortSourceGPIOE
#define LEFT_BUTTON_V2_EXTI_PIN_SOURCE      EXTI_PinSource6
#define LEFT_BUTTON_V2_EXTI_IRQn            EXTI9_5_IRQn
#define LEFT_BUTTON_V2_EXTI_IRQ_HANDLER     EXTI9_5_IRQHandler
 ...
 */
#define	UP_BUTTON_V2_PIN	        GPIO_Pin_8
#define	UP_BUTTON_V2_GPIO_PORT	        GPIOE
#define	UP_BUTTON_V2_GPIO_CLK	        RCC_AHBPeriph_GPIOE
#define	UP_BUTTON_V2_EXTI_LINE	        EXTI_Line8
#define	UP_BUTTON_V2_EXTI_PORT_SOURCE	EXTI_PortSourceGPIOE
#define	UP_BUTTON_V2_EXTI_PIN_SOURCE	EXTI_PinSource8
#define	UP_BUTTON_V2_EXTI_IRQn	        EXTI9_5_IRQn
#define	UP_BUTTON_V2_EXTI_IRQ_HANDLER	EXTI9_5_IRQHandler
 ...
 */
#define SEL_BUTTON_V2_PIN                   GPIO_Pin_7
#define SEL_BUTTON_V2_GPIO_PORT             GPIOE
#define SEL_BUTTON_V2_GPIO_CLK              RCC_AHBPeriph_GPIOE
#define SEL_BUTTON_V2_EXTI_LINE             EXTI_Line7
#define SEL_BUTTON_V2_EXTI_PORT_SOURCE      EXTI_PortSourceGPIOE
#define SEL_BUTTON_V2_EXTI_PIN_SOURCE       EXTI_PinSource7
#define SEL_BUTTON_V2_EXTI_IRQn             EXTI9_5_IRQn
#define SEL_BUTTON_V2_EXTI_IRQ_HANDLER      EXTI9_5_IRQHandler
