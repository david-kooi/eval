...
#define LINK_USER_MAX_TX_DATA_FIELD_SIZE     128/*!< Link Layer Payload maximum size; */ //modified from 245  
...
typedef enum LINK_ATTR_ID
{
  ...
  LINK_ATTR_ID_ACCESS_NUMBER,/*!< The Access no., for details refer EN 13757-3*/
  LINK_ATTR_ID_STATUS, /*!< The Status, for details refer EN 13757-3*/ 
  LINK_ATTR_ID_CONFIG_WORD, /*!< The Signaure word or Configuration word, for details refer EN 13757-3*/
...
/**
* @brief  SPIRIT1 WMBus Link Configuration word field definition.
*/
typedef struct ConfigWord
{
  uint8_t hopCounter:2;       /*!< Payload Size; */
  uint8_t Content:2;   /*!< Payload buffer capacity; */
  uint8_t num_blocks:4;/*!< pointer to Payload buffer; */
  uint8_t encryMode:4;
  uint8_t reserved:1;
  uint8_t sync:1;
  uint8_t accessibility:1;
  uint8_t bidir_Comm:1;
}ConfigWord;
/**
...
//  /*>>>>Added for multi encryption support>>>>>*/
//  uint8_t    accessNum;
//  uint8_t status_field; // added by me
