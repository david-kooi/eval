...
The example shows how to configure the packets in order to transmit or receive MBUS packets (format A only).
...
A Virtual Com stream can be opened by defining the preprocessing
