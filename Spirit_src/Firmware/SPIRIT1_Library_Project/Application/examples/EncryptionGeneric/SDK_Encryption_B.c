...
*/
uint8_t vectcBuff[N_BYTES], vectcEncBuff[N_BYTES],
cRxData;
...
void main (void)
{
  ...
  while (1)
  {
    ...
    /* read the RX FIFO */
    SpiritSpiReadLinearFifo(cRxData, vectcEncBuff);
    SpiritCmdStrobeFlushRxFifo();
    
    /* write data to be decrypted */
    SpiritAesWriteDataIn(vectcEncBuff, N_BYTES);
    ...
    SpiritAesReadDataOut(vectcBuff, N_BYTES);
