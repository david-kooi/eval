...
/**
* @addtogroup SDK_Sniff_A                                      SDK Sniff A
* @brief Device A configured as a transmitter.
* @details This code explains how to configure and manage in the simpler way 
*          a transmitter of basic packets. This is the same of the SDK Basic Generic A,
*          but used to demonstrate the Sniff in the Rx side.
* @{
*/

/**
* @defgroup Sniff_A_Private_TypesDefinitions                   Sniff A Private TypesDefinitions
* @{
*/
...
/**
* @defgroup Sniff_A_Private_Defines                            Sniff A Private Defines
* @{
*/
...
/**
* @defgroup Sniff_A_Private_Macros                             Sniff A Private Macros
* @{
*/
...
/**
* @defgroup Sniff_A_Private_Variables                           Sniff A Private Variables
* @{
*/
...
/**
* @defgroup Sniff_A_Private_FunctionPrototypes                                         Sniff A Private FunctionPrototypes
* @{
*/
...
/**
* @defgroup Sniff_A_Private_Functions                                                  Sniff A Private Functions
* @{
*/
...
#ifdef SYNC_WRONG_ON_PURPOSE
void wrongSync(void)
{
  static uint8_t ws_count=0;
  
  /* the following part is to send on purpose a wrong packet every 5 */
  if(++ws_count==5)
  {
    ws_count=0;
    SpiritPktBasicSetSyncWords(((~SYNC_WORD)^0xabcd1234),4);
    printf("sync error introduced\n\r");
  }
  if(ws_count==1)
  {
    SpiritPktBasicSetSyncWords(SYNC_WORD,4);
  }
}
#endif
...
void main (void)
{
  ...
  SpiritGpioInit(&(SGpioInit){SPIRIT_GPIO_2, SPIRIT_GPIO_MODE_DIGITAL_OUTPUT_LP, SPIRIT_GPIO_DIG_OUT_TX_STATE});
